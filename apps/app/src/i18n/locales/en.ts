...
export default {
  ...
  "ui_artifacts.kind.calendar_day": "Day agenda",
  "ui_artifacts.kind.calendar_day_desc": "Calendar events, locations, status, and focus time.",
  ...
  "ui_artifacts.kind.work_progress": "Progress widgets",
  "ui_artifacts.kind.work_progress_desc": "Goals, learning, payroll, leave, and other compact personal widgets.",
  "ui_artifacts.kind.metrics_glance": "At-a-glance metrics",
  "ui_artifacts.kind.metrics_glance_desc": "Meetings, replies, tasks, critical items, and focus time.",
} as const;
