...
export default {
  ...
  "change_location.browse": "Browse…",
  "change_location.browse_chat_title": "Choose a project folder",
  "change_location.browse_global_title": "Choose where chats are saved",
  "change_location.chat_desc": "Use an existing project folder for this empty chat.",
  "change_location.chat_title": "Use a specific folder",
  "change_location.custom_copy": "Use this when a chat should work inside an existing project.",
  "change_location.custom_folder": "Custom folder",
  "change_location.default_copy": "Created automatically. Nothing for you to manage.",
  "change_location.default_location": "Default location",
  "change_location.global_desc": "OpenWork creates one folder for each new chat.",
  "change_location.global_title": "Choose where chats are saved",
  "change_location.path_label": "Folder path",
  "change_location.path_placeholder": "Select or paste a folder path",
  "change_location.path_required": "Enter a folder path.",
  "change_location.recommended": "Recommended",
  "change_location.save_failed": "Could not save the folder location.",
  "change_location.server_unavailable": "OpenWork server is unavailable. Reconnect the local worker and try again.",
  "change_location.specific_folder_unavailable": "Using a specific folder is unavailable here.",
  "change_location.workspace_create_failed": "Could not create the workspace for that folder.",
  "chat.lives_in": "This chat lives in {path}",
  "chat.use_specific_folder": "Use a specific folder",
  ...
  "welcome.chat_folder_error": "Failed to create chat folder.",
  "welcome.creating_workspace": "Creating workspace\u2026",
  "welcome.change_location": "Change location",
  "welcome.chats_saved_in": "Chats are saved in {root}",
  "welcome.get_started": "Get started",
  "welcome.or": "or",
  "welcome.developer_section": "Developer",
  ...
  "welcome.start_chatting": "Start chatting",
  "welcome.step_chat": "Chat",
  "welcome.step_chat_desc": "Describe what you need. OpenWork handles the rest.",
  "welcome.step_review": "Review",
  "welcome.step_review_desc": "Watch it work, approve actions, iterate.",
  "welcome.step_reuse": "Reuse",
  "welcome.step_reuse_desc": "Save what worked as skills and automations.",
  "welcome.showcase_label": "What OpenWork can do",
  ...
  "welcome.showcase_shared_extensions": "Shared extensions",
  "welcome.showcase_shared_extensions_desc": "Share approved skills, MCPs, and plugins with your organization.",
  "welcome.showcase_provision_team": "Provision your team",
  "welcome.showcase_provision_team_desc": "Manage workspaces, models, and permissions.",
  ...
  "suggestions.automate_web_task": "Automate a web task",
  "suggestions.automate_web_task_desc": "Use the built-in browser for repetitive steps.",
  "suggestions.automate_web_task_prompt": "Use the built-in browser to automate a repetitive web task. Ask what website and steps I want automated, then propose a safe plan.",
  "suggestions.clean_spreadsheet": "Clean up a spreadsheet",
  "suggestions.clean_spreadsheet_desc": "Drop in a CSV and describe the result.",
  "suggestions.clean_spreadsheet_prompt": "Help me clean up a spreadsheet or CSV. Ask me to attach the file, then summarize the columns and suggest cleanup steps.",
  "suggestions.draft_document": "Draft a document",
  "suggestions.draft_document_desc": "Reports, emails, and briefs from bullets.",
  "suggestions.draft_document_prompt": "Help me draft a document from rough bullets. Ask what kind of document I need, the audience, and the key points.",
  "suggestions.summarize_week": "Summarize my week",
  "suggestions.summarize_week_desc": "Pull highlights from email and calendar.",
  "suggestions.summarize_week_prompt": "Summarize my week. Pull together highlights from email, calendar, and local notes I provide, then organize them into priorities and follow-ups.",
  "suggestions.what_do_you_need": "What do you need done?",
