...
export default {
  ...
  "settings.engine_v2_preview": "OpenCode v2 preview",
  "settings.engine_v2_preview_badge": "Preview",
  "settings.engine_v2_preview_desc": "Restarts the local engine on a prerelease build.",
