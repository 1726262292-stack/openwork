...
export default {
  ...
  "mcp.add_modal_subtitle": "Connect a custom MCP to this workspace on this device. Organization-managed connections use OpenWork Connect.",
  "mcp.add_modal_title": "Add MCP on this device",
  ...
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "This desktop handles sign-in and token refresh, and encrypts the OAuth credentials in local app data. This is separate from OpenWork Connect and does not connect other devices.",
