...
export default {
  ...
  "settings.engine_v2_preview": "Prévia do OpenCode v2",
  "settings.engine_v2_preview_badge": "Prévia",
  "settings.engine_v2_preview_desc": "Reinicia o engine local com uma versão de pré-lançamento.",
