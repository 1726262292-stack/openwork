...
function inputFromDetail(detail: AutomationDetail): CreateAutomationDefinition {
...
export function AutomationsPage(props: { providerCatalog?: AutomationProviderCatalog } = {}) {
  ...
  const createInitial = useMemo<CreateAutomationDefinition | null>(() => requestedScript ? {
