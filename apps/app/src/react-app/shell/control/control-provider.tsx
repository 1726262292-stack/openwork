      ...
      args: [
        {
          ...
          required: true,
          description:
            "Settings tab: general | ai | preferences | permissions | shell | extensions | skills | environment | advanced | appearance | updates | recovery | debug | cloud-account | bootstrap | cloud-workers | cloud-providers | cloud-marketplaces",
        },
      ],
