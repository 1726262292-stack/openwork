 ...
 */
export const ORGANIZATION_CAPABILITY_KEYS = ["installLinks", "mcpConnections", "codemodeScripts", "remoteMcpApps", "pluginMcpApps", "cloud"] as const
...
export function normalizeOrganizationCapabilities(metadata: MetadataInput): OrganizationCapabilities {
  ...
  return {
    ...
    pluginMcpApps: raw.pluginMcpApps === true,
...
export function readOrganizationCapabilityOverrides(metadata: MetadataInput): Partial<OrganizationCapabilities> {
  ...
  if (typeof raw.pluginMcpApps === "boolean") {
    capabilities.pluginMcpApps = raw.pluginMcpApps
  }
