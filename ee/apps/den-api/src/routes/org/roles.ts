...
import { validateAssignableOrganizationPermissionRecord } from "@openwork-ee/den-core/organization-access"
import { isProtectedOrganizationRoleName } from "@openwork-ee/den-core/organization-role-hierarchy"
import { revokeCredentialsForOrganizationRoleMembers } from "../../organization-role-credential-revocation.js"
import { serializePermissionRecord } from "@openwork-ee/den-core/orgs"
import type { OrgRouteVariables } from "@openwork-ee/den-core/routes/org/shared"
import { createRoleId, ensureOrganizationSuperAdmin, idParamSchema, normalizeRoleName, orgAccessFailureStatus, replaceRoleValue, splitRoles } from "@openwork-ee/den-core/routes/org/shared"
