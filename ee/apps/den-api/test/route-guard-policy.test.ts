...
const routeGuardExceptions = new Map<string, string>([
  ...
  ["GET /api/auth/scim/v2/Groups", "SCIM bearer token is validated before listing teams as groups"],
  ["POST /api/auth/scim/v2/Groups", "SCIM bearer token is validated before creating teams from groups"],
  ["GET /api/auth/scim/v2/Groups/:groupId", "SCIM bearer token is validated before reading teams as groups"],
  ["PUT /api/auth/scim/v2/Groups/:groupId", "SCIM bearer token is validated before replacing teams from groups"],
  ["PATCH /api/auth/scim/v2/Groups/:groupId", "SCIM bearer token is validated before patching teams from groups"],
  ["DELETE /api/auth/scim/v2/Groups/:groupId", "SCIM bearer token is validated before deleting teams from groups"],
