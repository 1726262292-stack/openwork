...
// Narration is loaded from the approved script (evals/voiceovers/google-workspace-multi-account.md).
// The runner fails this flow if the narration drifts from that script.
const vo = await loadVoiceoverParagraphs("google-workspace-multi-account");
if (!vo) throw new Error("Missing approved voice-over script for google-workspace-multi-account.");

export default defineFlow({
  id: "google-workspace-multi-account",
  ...
  steps: [
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 1", {
          voiceover: vo[0],
          // "Alex runs IT for Acme Robotics, and Google Workspace is already set up for t"
          action: async () => {
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 2", {
          voiceover: vo[1],
          // "He adds Acme Labs as its own connector, named so people recognize it. The or"
          action: async () => {
            // TODO: drive the app as the end user (ctx.clickText, ctx.fill, ...)
          },
          assert: async () => {
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 3", {
          voiceover: vo[2],
          // "Jordan works in both companies. In her app both Google connectors now appear"
          action: async () => {
            // TODO: drive the app as the end user (ctx.clickText, ctx.fill, ...)
          },
          assert: async () => {
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 4", {
          voiceover: vo[3],
          // "She connects Acme Labs, and her real browser opens Google's consent screen —"
          action: async () => {
            // TODO: drive the app as the end user (ctx.clickText, ctx.fill, ...)
          },
          assert: async () => {
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 5", {
          voiceover: vo[4],
          // "Back in OpenWork both connectors read Connected, each showing the real email"
          action: async () => {
            // TODO: drive the app as the end user (ctx.clickText, ctx.fill, ...)
          },
          assert: async () => {
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 6", {
          voiceover: vo[5],
          // "Now she asks her AI coworker to draft the supplier email in Acme Labs. It do"
          action: async () => {
            // TODO: drive the app as the end user (ctx.clickText, ctx.fill, ...)
          },
          assert: async () => {
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 7", {
          voiceover: vo[6],
          // "The draft is really sitting in her Acme Labs mailbox, and the link she gets "
          action: async () => {
            // TODO: drive the app as the end user (ctx.clickText, ctx.fill, ...)
          },
          assert: async () => {
    ...
    },
    {
      ...
      run: async (ctx) => {
        await ctx.prove("TODO: claim for frame 8", {
          voiceover: vo[7],
          // "And for a company with a single Google domain, nothing changed at all: one c"
          action: async () => {
            // TODO: drive the app as the end user (ctx.clickText, ctx.fill, ...)
          },
          assert: async () => {
