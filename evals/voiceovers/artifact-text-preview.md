# artifact-text-preview — Text files open in the side panel, editable and saveable

User feedback (Jay, via the in-app feedback form): "Can you add a preview panel
to view text files … it saves the hassle of opening the files in a separate app
and also helps to make changes to the file content before saving." Until now,
plain-text artifacts (txt, log, json, yaml, code) always bounced to the OS
default app, even though the side panel already previews markdown, sheets,
PDFs, images and HTML — and already knows how to edit and save text. This demo
shows text files joining the panel as first-class artifacts.
