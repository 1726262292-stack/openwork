...
describe("portable Automations core", () => {
  ...
  test("creates stable revision and occurrence identities", () => {
    ...
    expect(automationOccurrenceIdentity({
      automationId: "automation_a", revisionId: "revision_a", trigger: "scheduled", scheduledFor: 10,
    })).toEqual({
      occurrenceId: "automation-occurrence:automation_a:revision_a:scheduled:10",
      idempotencyKey: "automation:automation_a:revision_a:scheduled:10",
    })
  })
