...
const CATALOG: readonly ArtifactDefinition[] = [
  ...
  },
  {
    ...
    title: "Day agenda",
    description: "A chronological calendar agenda with meetings, locations, status, and a focus window.",
    keywords: ["calendar", "agenda", "events", "meetings", "schedule", "google calendar", "outlook calendar", "availability", "today"],
    example: CALENDAR_DAY_EXAMPLE,
    payloadSchema: uiArtifactCalendarDaySchema,
  },
  {
  ...
  },
  {
    ...
    description: "Goal, learning, payroll, leave, and other compact personal work progress widgets.",
    keywords: ["widgets", "progress", "goals", "learning", "payroll", "payslip", "leave", "balance", "courses"],
    example: PROGRESS_EXAMPLE,
    payloadSchema: uiArtifactProgressSchema,
  },
  {
    artifactId: "metrics.glance",
    title: "At-a-glance metrics",
    description: "A screenshot-inspired strip of meetings, replies, tasks, critical items, and a recommended focus window.",
    keywords: ["summary", "brief", "today", "glance", "metrics", "meetings", "replies", "tasks", "critical", "focus"],
    example: METRICS_GLANCE_EXAMPLE,
    payloadSchema: uiArtifactMetricsGlanceSchema,
  },
]
